...
class ProductModel extends Product {
  ...
  factory ProductModel.formEntity(Product entity) => ProductModel(
      id: entity.id,
      name: entity.name,
      description: entity.description,
      priceTags: entity.priceTags
          .map((priceTag) => PriceTagModel.formEntity(priceTag))
          .toList(),
      categories: entity.categories
          .map((category) => CategoryModel.formEntity(category))
          .toList(),
