...
class FilterCubit extends Cubit<FliterProductParams> {
  final TextEditingController searchController = TextEditingController();
  FilterCubit() : super(const FliterProductParams());
  ...
  void reset() => emit(const FliterProductParams());
}
