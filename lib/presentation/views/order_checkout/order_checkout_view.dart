...
import 'package:eshoes_clean_arch/core/extension/string_extension.dart';
...
import 'package:eshoes_clean_arch/presentation/blocs/home/navbar_cubit.dart';
...
import 'package:eshoes_clean_arch/presentation/widgets/outline_label_card.dart';
import 'package:flutter/material.dart';
import 'package:eshoes_clean_arch/core/services/services_locator.dart' as di;
...
class OrderCheckoutView extends StatelessWidget {
  ...
  const OrderCheckoutView({required this.items, Key? key}) : super(key: key);
      ...
      child: BlocListener<OrderAddCubit, OrderAddState>(
        listener: (context, state) {
          ...
          if (state is OrderAddLoading) {
            ...
            EasyLoading.showError("Error to Add");
          }
        },
        child: Scaffold(
          appBar: AppBar(
                              ...
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${state.selectedDeliveryInformation!.addressLineOne}, ${state.selectedDeliveryInformation!.addressLineTwo}, ${state.selectedDeliveryInformation!.zipCode}",
                                      style: const TextStyle(
                                        fontSize: 14,
