...
import 'package:eshoes_clean_arch/presentation/widgets/alert_card.dart';
import 'package:eshoes_clean_arch/presentation/widgets/input_form_button.dart';
import 'package:eshoes_clean_arch/presentation/widgets/product_card.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: BlocBuilder<FilterCubit, FliterProductParams>(
                    builder: (context, state) {
                      return TextField(
                        autofocus: false,
                        controller:
                        ...
                        onSubmitted: (value) => context.read<ProductBloc>().add(
                              GetProducts(
                                FliterProductParams(keyword: value),
                              ),
                            ),
